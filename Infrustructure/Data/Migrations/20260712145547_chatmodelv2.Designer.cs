...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260712145547_chatmodelv2")]
    partial class chatmodelv2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Chats.AiModel.DesignState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InpaintMaskPrompt")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ModificationArea")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Neckline")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OriginalImageReference")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.Chats.AiModel.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Shared.Otp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Shared.RefreshToken", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Chats.AiModel.Image", b =>
                {
                    b.HasOne("Domain.Entities.Chats.AiModel.ModelGeneratedDesign", "Design")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Domain.Entities.Chats.AiModel.ModelGeneratedDesign", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Chats.AiModel.DesignState", "DesignState")
                        .WithMany()
                        .HasForeignKey("DesignStateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Customer");

                    b.Navigation("DesignState");
                });
